...
interface EditProductSubCategoryDialogProps {
    isOpen: boolean;
    onClose: () => void;
...
const EditProductSubCategoryDialog: React.FC<EditProductSubCategoryDialogProps> = ({ isOpen, onClose, subcategory, onSuccess }) => {
...
export default EditProductSubCategoryDialog;
