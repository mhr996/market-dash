...
interface EditShopCategoryDialogProps {
    isOpen: boolean;
    onClose: () => void;
...
const EditShopCategoryDialog: React.FC<EditShopCategoryDialogProps> = ({ isOpen, onClose, category, onSuccess }) => {
    ...
    const handleOpenFullEdit = () => {
        if (category) {
            window.open(`/shops/categories/edit/${category.id}`, '_blank');
        }
    };
...
export default EditShopCategoryDialog;
