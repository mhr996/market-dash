...
const PreviewShopCategory = () => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const { error } = await supabase.from('categories_shop').delete().eq('id', category.id);
            if (error) throw error;
        ...
        return (
            <div className="panel">
                <div className="text-center py-8">
                    ...
                    <Link href="/shops/categories" className="btn btn-primary mt-4">
                        Back to Categories
                    </Link>
                </div>
            </div>
            ...
            <div className="mb-5">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h5 className="text-lg font-semibold dark:text-white-light">Shop Category Preview</h5>
                    </div>
                    <div className="flex items-center gap-2">
                        <Link href={`/shops/categories/edit/${category.id}`} className="btn btn-primary gap-2">
                            <IconEdit />
                            Edit
                        </Link>
...
export default PreviewShopCategory;
